...
import { findCommercesInRange } from '../services/ProductService';
...
export class SearchResult extends React.Component {
    ...
    componentDidMount() {
        findCommercesInRange(this.props.max)
            .then(commerces => {
                this.setState({ isLoaded: true, results: this.createBoxesFromArray(commerces) })
            })
            .catch(() => this.setState({ isLoaded: true, alert: true }));
    }
